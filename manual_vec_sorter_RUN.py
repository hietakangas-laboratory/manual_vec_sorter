...
class Man_vec_sort:
    ...
    def __init__(self):
        ...
        self.__r_dir_prompt = Label(self.__window,
                                    text='Select tiff folder (tiffs '
                                         'contain manually drawn vectors):') \
        ...
        self.__a_dir_prompt = Label(self.__window,
                                    text='Select LAM analysis "Samples" folder:') \
            .grid(row=6, column=1)
    ...
    def go(self):
        ...
        if self.__rfolder.get() == '' or self.__imgj_path.get() == '' or self.__afolder.get() == '':
            ...
            logging.basicConfig(
                filename='%s/manual_vector_sorter.log' % self.__rfolder.get(),
